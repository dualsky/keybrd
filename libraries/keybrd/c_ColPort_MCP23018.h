...
class c_ColPort_MCP23018 : public c_ColPort
{
    ...
    public:
        ...
        //example instantiation for port A columns: c_ColPort_MCP23018 portACols(0x20, 0x00, 0x0C, 0x12, 1<<0 | 1<<1 );
        //example instantiation for port B columns: c_ColPort_MCP23018 portBCols(0x20, 0x01, 0x0D, 0x13, 1<<0 | 1<<1 );
        c_ColPort_MCP23018(const uint8_t ADDR, volatile unsigned char& IODIRx, volatile unsigned char& GPPUx,
