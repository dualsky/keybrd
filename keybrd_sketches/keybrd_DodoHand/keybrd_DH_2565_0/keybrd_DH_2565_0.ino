...
l_Code* ptrsCodes_Le1[] = {&s_b,        &s_numLock,     &code_null,     &s_numLock,     &s_numLock};
...
//row_L2 center keys
l_Code* ptrsCodes_Lc0[] = {&s_a,        &s_1,           &s_comma,       &code_null,     &code_null};
l_Key_Layered k_Lc0(ptrsCodes_Lc0);                 //todo: replace above code_null with L/R Modf
...
//row_R4 east (west and east are swapped compared to left matrix because right PCB is flipped)
