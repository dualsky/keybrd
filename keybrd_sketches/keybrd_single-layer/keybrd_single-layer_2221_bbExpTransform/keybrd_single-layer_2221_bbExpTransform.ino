/* keybrd_single-layer_2221_bbExpTransform.ino, 4-key layout:
        1       2       3       4
        a       b       c       d
*/
// ********** INCLUDES **********
...
c_Key* const ptrsKey_Exp_B0[] = { &k_##K00, &k_##K01 }; \
c_Key* const ptrsKey_Exp_B1[] = { &k_##K10, &k_##K11 };
//                                  pin A0    pin A1
...
// *********** LEFT ROWS OF KEYS ************
c_Row_Ex row_L0(ptrsKey_Exp_B0, 2);
c_Row_Ex row_L1(ptrsKey_Exp_B1, 2);
